...
from amr_msgs.msg import BoundingBox2D
from amr_msgs.msg import KeyPoint2D
from amr_msgs.msg import KeyPoint3D
from amr_msgs.msg import Detection
...
class Yolov8VisualizerNode(LifecycleNode):
    ...
    def on_activate(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        self.image_sub = message_filters.Subscriber(
            self, Image, "camera/camera/color/image_raw", qos_profile=self.image_qos_profile)
